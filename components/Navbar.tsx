        ...
        <div className="flex items-center justify-between h-28 md:h-40">
          ...
          <Link href="/" className="flex items-center">
            <Image
              ...
              width={500}
              height={120}
              className="h-20 md:h-40 w-auto dark:brightness-0 dark:invert"
              priority
            />
          </Link>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a
              ...
              className="inline-flex flex-col items-center gap-0.5 bg-[#25D366] text-gn-white px-4 py-2 text-sm font-medium tracking-wide hover:bg-[#128C7E] transition-colors"
              aria-label="Agendar consulta por WhatsApp"
            >
              <span className="text-[10px] uppercase tracking-wider text-white/80">Agendá tu consulta</span>
