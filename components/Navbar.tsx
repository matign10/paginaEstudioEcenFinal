        ...
        <div className="flex items-center justify-between h-28 md:h-32">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a
              ...
              className="group inline-flex items-center gap-3 bg-gn-black text-gn-white pl-4 pr-3 py-2 text-sm font-medium tracking-wide hover:bg-gn-gray transition-colors"
              aria-label="¿Necesita asesoramiento penal? Contáctenos por WhatsApp"
            >
              <span>¿Necesita asesoramiento penal?</span>
              <span className="inline-flex items-center justify-center w-7 h-7 bg-gn-white text-gn-black group-hover:bg-gn-black group-hover:text-gn-white transition-colors">
